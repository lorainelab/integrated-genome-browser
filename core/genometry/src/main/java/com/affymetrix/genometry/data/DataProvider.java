...
public interface DataProvider {
    ...
    public default Optional<String> getSpeciesNameForVersionName(String versionName) {
        return Optional.empty();
    }

    public default Optional<String> getCommonSpeciesNameForVersionName(String versionName) {
        return Optional.empty();
    }
