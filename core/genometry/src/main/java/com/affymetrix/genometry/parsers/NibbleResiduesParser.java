    ...
    public static void main(String[] args) {
        try {
            ...
            if (args.length >= 4) {
                ...
                System.err.println("Usage: java -cp <exe_filename> com.affymetrix.genometry.parsers.NibbleResiduesParser [seq_name] [in_file] [out_file] [seq_version]. Alternatively, provide just a xxx.bnib file to convert it to xxx.fasta");
                System.exit(1);
            }
