...
public interface Parser {
     ...
     * @param genomeVersion the GenomeVersion
     ...
     * @throws Exception
     */
    public List<? extends SeqSymmetry> parse(InputStream is, GenomeVersion genomeVersion, String nameType, String uri, boolean annotate_seq) throws Exception;
}
