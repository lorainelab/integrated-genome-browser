...
/**
 * Container to hold chrom, strand, firstStartPosition, lastStartPosition, numberRecords, and binaryType from a useq
 * data slice.
...
public class SliceInfo {
     ...
     * Boolean (o), Byte(b), Short(s), Integer(i), Long(l), Float(f), Double(d), Char(c), String/Text encoded in
     * UTF-8(t),
