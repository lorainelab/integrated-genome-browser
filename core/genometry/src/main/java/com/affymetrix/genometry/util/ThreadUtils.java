...
public final class ThreadUtils {
     ...
     * Currently returns an Executor that uses a single worker thread operating
     * off an unbounded queue
     * therefore tasks (Runnables added via exec.execute()) on the Executor are
     * guaranteed to
     * execute sequentially in order, and no more than one task will be active
     * at any given time
     */
