...
//			loadBuffer(bistr, buffer);
     ...
     * @param isMask	Boolean variable to check if it maskBlocks or nBlocks. True for the maskBlocks and false for
     * nBlocks.
     ...
     * @param isFirst	Boolean to determine if residues are to be read from first or last position. True for the first
     * and false for last.
