...
import com.affymetrix.genometryImpl.symmetry.impl.Psl3Sym;
import com.affymetrix.genometryImpl.symmetry.impl.SeqSymmetry;
import com.affymetrix.genometryImpl.symmetry.impl.SeqSymmetryConverter;
...
public abstract class AbstractPSLParser implements AnnotationWriter, IndexWriter, Parser {
	...
	private UcscPslSym determineSym(
		...
		if (is_psl3) {
			...
			sym = new UcscPslSym(type, match, mismatch, repmatch, n_count, q_gap_count, q_gap_bases, t_gap_count, t_gap_bases, same_orientation, qseq, qmin, qmax, tseq, tmin, tmax, blockcount, blocksizes, qmins, tmins, in_bottom_of_link_psl);
		}
