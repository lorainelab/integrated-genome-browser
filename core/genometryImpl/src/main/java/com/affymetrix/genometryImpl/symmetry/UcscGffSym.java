...
/**
 * A sym to efficiently store GFF 1.0 annotations. See
...
public final class UcscGffSym extends SingletonSymWithProps implements Scored {
    ...
    /**
     * A pattern used to test whether this is GFF1 or GFF2. If the pattern
     * matches, then Matcher.group(1) will contain the GFF1 ID.
     * <p>
