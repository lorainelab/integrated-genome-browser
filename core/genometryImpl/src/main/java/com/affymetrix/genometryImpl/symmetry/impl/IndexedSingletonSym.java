...
/**
 * Holds a reference to a "parent" symmetry and an index within it. All requests
 * for properties or scores return those of the parent, and will throw
 * exceptions if the parent is null.
 */
public final class IndexedSingletonSym extends SingletonSeqSymmetry implements IndexedSym, SymWithProps {
    ...
    /**
     * Constructor. Be sure to also call {@link #setParent} and
     * {@link #setIndex}.
     */
    ...
    public void setParent(ScoredContainerSym par) {
        parent = par;
    }
    ...
    public void setID(String symid) {
        id = symid;
    }
