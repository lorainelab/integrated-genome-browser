...
public final class SeqSymmetryConverter {
     ...
     * Unknown values in the PSL will be set to -1: matches, mismatches,
     * repmatches, ncount, gNumInsert, qBaseInsert, tNumInsert, tBaseInsert.
     *
     ...
     *
     * @param targetseq the target sequence; calculate query seq assuming no
     * gaps in query. Unknown values in the PSL will be set to -1: matches,
     * mismatches, repmatches, ncount, gNumInsert, qBaseInsert, tNumInsert,
     * tBaseInsert.
     * @param type The PSL type parameter
     */
    public static UcscPslSym convertToPslSym(SeqSymmetry sym, String type,
        ...
        BioSeq queryseq = new BioSeq(qname, curlength);
    ...
    /**
     * Converts any SeqSymmetry into a UcscPslSym. Unknown values in the PSL
     * will be set to -1: matches, mismatches, repmatches, ncount, gNumInsert,
     * qBaseInsert, tNumInsert, tBaseInsert.
     *
     * @param targetseq indicates span in symmetry to be used as "target" span
     * for UcscPslSym
     * @param queryseq indicates span in symmetry to be used as "query" span for
     * UcscPslSym
     */
    public static UcscPslSym convertToPslSym(SeqSymmetry sym, String type,
