	...
	implements WindowListener, ActionListener, ItemListener
{
	...
	protected void getGoing() {
		...
		seqview.setFont(new Font("Courier", Font.BOLD, 12));
	...
	public void setupMenus(Frame dock) {
		...
		setMenuItemState(lineSpacingMenu, smallLineSpacingCBMenuItem);
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if (theItem == blueMenuItem) { setAnnotColors(Color.blue); }
		else if (theItem == greenMenuItem) {  setAnnotColors(Color.green); }
		else if (theItem == magentaMenuItem) {  setAnnotColors(Color.magenta); }
		else if (theItem == whiteMenuItem) {  setAnnotColors(Color.white); }
