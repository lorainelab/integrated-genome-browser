...
public final class ChpParser {
     ...
     * Probably not necessary for sequencing chips (but those aren't supported
     * yet)
     *
    ...
    /**
     *
     * The FusionCHPQuantificationData class provides parsing capabilities for
     * both 3' IVT (RMA and PLIER)
     * CHP files and Exon CHP files. The difference between the two are that the
     * probe set result (ProbeSetQuantificationData
     * class) stores an "id" for Exon results and "name" for 3' IVT results. The
     * "name" property will be
