...
public interface TrackConstants {
    ...
    static final String PREF_SOFT_CLIP_COLOR = "Soft Clip Color";
    static final String PREF_SHOW_SOFT_CLIPPED_RESIDUES = "Show soft clipped residues";
    ...
    static final boolean default_showSoftClippedResidues = true;
