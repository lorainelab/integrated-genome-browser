 ...
 * @author lorainelab
 */
@aQute.bnd.annotation.component.Component(name = SeqGroupView.COMPONENT_NAME, provide = SeqGroupViewI.class)
public class SeqGroupView implements SeqGroupViewI {

    public static final String COMPONENT_NAME = "SeqGroupView";
