...
@Component(name = SeqGroupViewGUI.COMPONENT_NAME, provide = IGBTabPanelI.class)
public class SeqGroupViewGUI extends IGBTabPanel {
    ...
    private void activate() {
        super.activate(BUNDLE.getString("genomeTab"), BUNDLE.getString("genomeTab"), BUNDLE.getString("currentGenomeTooltip"), true, TAB_POSITION);
