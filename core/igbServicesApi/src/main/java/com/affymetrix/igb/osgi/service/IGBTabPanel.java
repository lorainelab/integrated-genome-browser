...
public abstract class IGBTabPanel extends JPanel implements IGBTabPanelI {
    ...
    public void activate(String displayName, String title, String tooltip, boolean main) {
        activate(displayName, title, tooltip, main, DEFAULT_TAB_POSITION);
    }

    public void activate(String displayName, String title, String tooltip, boolean focus, int position) {
    ...
    @Override
    public GenericAction getSelectAction() {
        return selectAction;
    }
