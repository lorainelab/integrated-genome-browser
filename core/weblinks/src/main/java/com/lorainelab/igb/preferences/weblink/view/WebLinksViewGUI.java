 ...
 * @author nick
 */
@Component(name = WebLinksViewGUI.COMPONENT_NAME, immediate = true, provide = WebLinkDisplayProvider.class)
public class WebLinksViewGUI extends JPanel implements WebLinkDisplayProvider {

    public static final String COMPONENT_NAME = "WebLinksViewGUI";
    ...
    public WebLinksViewGUI() {
        ...
        frame = PreferenceUtils.createFrame("Web Links Tool", this);
        initComponents();
    }
