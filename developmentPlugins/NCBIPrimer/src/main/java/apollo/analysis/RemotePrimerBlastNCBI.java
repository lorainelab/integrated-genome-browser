...
public class RemotePrimerBlastNCBI {
     ...
     */
    public String runAnalysis(StrandedFeatureSetI cs, SequenceI seq, int offset) throws Exception {
...
//    apollo.util.IOUtil.informationDialog("Primer-BLAST request sent");
    ...
    private String retrieveResponse(InputStream is, StrandedFeatureSetI cs, int offset, FeatureListI fl) throws IOException, InterruptedException,
        ...
        return parser.parse(copy, cs, offset, opts.isRemovePairsNotInExons() ? fl : null);
    ...
    public static class PrimerBlastOptions {
        ...
        /**
         * Database to search against for primer specificity. refseq_rna -
         * Refseq mRNA genome_selected_species - Genome (reference assembly from
         * selected organisms) ref_assembly - Genome (chromosomes from all
         * organisms) nt - non-redundant set of transcripts
         *
         */
