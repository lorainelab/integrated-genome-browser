...
public class ParentXorOperator extends AbstractAnnotationOperator implements Operator {

    public ParentXorOperator(FileTypeCategory fileTypeCategory) {
        super(fileTypeCategory);
    }

    @Override
    public String getName() {
        return category.toString().toLowerCase() + "_parent_xor";
    }
