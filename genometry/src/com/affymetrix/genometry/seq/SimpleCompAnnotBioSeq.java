...
public class SimpleCompAnnotBioSeq
  ...
  public void addAnnotation(SeqSymmetry annot) {
    if (null == annots) { annots = new Vector(); }
    annots.add(annot);
  }
  ...
  /** NOT YET IMPLEMENTED */
  public Vector getIntersectedAnnotations(SeqSpan span) { return null; }
  /** NOT YET IMPLEMENTED */
  public Vector getContainedAnnotations(SeqSpan span) { return null; }
  //-----------------------------------------------------
