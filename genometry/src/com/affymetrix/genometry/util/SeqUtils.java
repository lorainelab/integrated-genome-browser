...
public abstract class SeqUtils {
 ...
 /* public static void trim(MutableSeqSymmetry sym) {
   ...
   */
  public static final boolean union(List<SeqSymmetry> syms, MutableSeqSymmetry resultSym, BioSeq seq) {
    resultSym.clear();
...
//    System.out.println("in stretchSpan(span, int, int) method");
  ...
  private static final SeqSpan getChildBounds(SeqSymmetry parent, BioSeq seq, int orientation) {
    int rev_count = 0;
    int for_count = 0;
    SeqSpan cbSpan = null;
    int min = Integer.MAX_VALUE;
