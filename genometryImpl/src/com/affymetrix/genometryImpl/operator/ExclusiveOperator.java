 ...
 * @author lfrohman
 */
public abstract class ExclusiveOperator extends AbstractAnnotationOperator implements Operator {
	
	protected SeqSymmetry operate(BioSeq aseq, SeqSymmetry symsA, SeqSymmetry symB){
		return operate(aseq, findChildSyms(symsA), findChildSyms(symB));
	}
	
	protected static SeqSymmetry operate(BioSeq seq, List<SeqSymmetry> symsA, List<SeqSymmetry> symsB) {
