...
public class PositionTextData extends USeqData{
	...
	public PositionTextData(DataInputStream dis, SliceInfo sliceInfo) throws IOException{
		this.sliceInfo = sliceInfo;
		read (dis);
	}
	 ...
	 * */
	public File write (File saveDirectory, boolean attemptToSaveAsShort) throws Exception{
