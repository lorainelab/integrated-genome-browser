 ...
 */
public final class Bgn extends SymLoaderInst implements AnnotationWriter, IndexWriter {

	public Bgn(URI uri, String featureName, AnnotatedSeqGroup group) {
	...
	public List<SeqSymmetry> parse(DataInputStream dis, String annot_type, AnnotatedSeqGroup group) {
		try {
			...
			Logger.getLogger(Bgn.class.getName()).log(Level.SEVERE, null, ex);
		}
		return null;
	}
	 ...
	 */
	private List<SeqSymmetry> parse(InputStream istr, String annot_type,
	...
	@Override
	public List<? extends SeqSymmetry> parse(InputStream is, boolean annotate_seq) throws Exception {
		return parse(is, featureName, group, annotate_seq);
	}
}
