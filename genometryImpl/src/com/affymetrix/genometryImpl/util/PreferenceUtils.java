...
public abstract class PreferenceUtils {
	...
	public static final String RESET_LOAD_CONFIRM_BOX_OPTION = "Confirm before load";
	public static final boolean default_ask_before_exiting = true;
	public static final boolean default_confirm_before_delete = false;
	...
	public static int userSpanLoadingConfirmed = 2;	//0-yes, 1-no, 2-not set yet
