...
/**
 * A view was redrawn and it's visible bounds have changed.
...
public class NeoViewBoxChangeEvent extends EventObject  {
  ...
  protected java.awt.geom.Rectangle2D.Double currentCoordBox;
  protected int id;
  boolean predraw;
   ...
   *    area of the widget
   */
  public NeoViewBoxChangeEvent(Object source, java.awt.geom.Rectangle2D.Double currentCoordBox) {
