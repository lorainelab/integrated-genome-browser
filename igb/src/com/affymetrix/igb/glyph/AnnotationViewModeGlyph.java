...
public class AnnotationViewModeGlyph extends ViewModeGlyph {
	...
	public AnnotationViewModeGlyph(ITrackStyleExtended style) {
		setHitable(false);
		setSpacer(spacer);
		setStyle(style);
	}
...
//			g.drawOval(hpix.x, hpix.y, hpix.width, hpix.height);
	...
	public String getViewMode() {
		return "annotation";// GenericAnnotGlyphFactory.getName()
	}
