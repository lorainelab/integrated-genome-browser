...
public class BarGraphGlyphFactory extends AbstractGraphGlyphFactory {
	...
	// glyph class
	private class BarGraphGlyph extends AbstractGraphGlyph {
	...
	public static AbstractGraphGlyph getGraphGlyph(GraphSym graf, GraphState gstate) {
		return new BarGraphGlyphFactory().createViewModeGlyph(graf, gstate);
	}
}
