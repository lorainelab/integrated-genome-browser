...
public final class CharSeqGlyph extends AbstractResiduesGlyph
  ...
  public void setResiduesProvider(CharIterator iter, int seqlength) {
    chariter = iter;
    residue_length = seqlength;
    residuesSet = true;
  }

  public CharIterator getResiduesProvider() { 
    return chariter; 
  }
      ...
      // ***** otherwise semantic zooming to show more detail *****
        ...
        if ( visible_seq_span > 0 ) {
          drawHorizontalResidues
            ( g, pixels_per_base, chariter, seq_beg_index, seq_end_index, seq_pixel_offset );
        }
      }
    }
    super.draw ( view );
