...
public class AnnotStyle implements IAnnotStyleExtended {
	...
	private static final Map<String, AnnotStyle> static_map = new LinkedHashMap<String, AnnotStyle>();
	private static AnnotStyle default_instance = null;
	...
	public static final AnnotStyle getInstance(String unique_name, boolean persistent) {
	...
	public static final List<AnnotStyle> getAllLoadedInstances() {
	 ...
	 * using it.
	 */
	public static final String getUniqueName(String name) {
	...
	private final void initFromNode(Preferences node) {
		if (DEBUG) {
	...
	private final void initFromPropertyMap(PropertyMap props) {
	...
	private final void initFromTemplate(AnnotStyle template) {
	...
	private final Preferences getNode() {
		return this.node;
	}
	 ...
	 *  in this way.)
	 */
	public static final AnnotStyle getDefaultInstance() {
		if (default_instance == null) {
			// Use a temporary variable here to avoid possible synchronization problems.
			AnnotStyle instance = new AnnotStyle(NAME_OF_DEFAULT_INSTANCE, true, null);
