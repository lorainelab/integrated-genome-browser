...
public class JTableCutPasteAdapter implements ActionListener {
   ...
   */
  public JTableCutPasteAdapter(JTable myJTable) {
    jTable1 = myJTable;
  ...
  public static void main(String[] args) {
    ...
    JTableCutPasteAdapter test_adapter = new JTableCutPasteAdapter(test_table);    
