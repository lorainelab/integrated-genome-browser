...
public class ThreadedDas2Client extends JComponent
  ...
  ThreadedDas2Client myself = null;
  ...
  public void itemStateChanged(ItemEvent evt) {
    //    System.out.println("ThreadedDas2Client received ItemEvent: " + evt);
    Object src = evt.getSource();

    // selection of DAS server
    if ((src == das_serverCB) && (evt.getStateChange() == ItemEvent.SELECTED)) {
      System.out.println("ThreadedDas2Client received SELECTED ItemEvent on server combobox");
    ...
    // selection of DAS source
      ...
      System.out.println("ThreadedDas2Client received SELECTED ItemEvent on source combobox");
	...
	setVersions();
      ...
      System.out.println("ThreadedDas2Client received SELECTED ItemEvent on version combobox");
    ...
    // selection of DAS region point
      ...
      System.out.println("ThreadedDas2Client received SELECTED ItemEvent on region combobox");
  ...
  public void actionPerformed(ActionEvent evt) {
    ...
    if (src == load_featuresB) {
      System.out.println("ThreadedDas2Client received ActionEvent on load features button");
      loadFeatures();
    }
  }
  ...
  public void loadFeatures() {
    ...
    final SimpleSeqSpan overlap = new SimpleSeqSpan(min, max, aseq);
  ...
  public static void main(String[] args) {
    ThreadedDas2Client testview = new ThreadedDas2Client();
