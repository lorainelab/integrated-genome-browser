 ...
 *
 * Under Unix, the default system browser is hard-coded to be 'firefox'.
 * Firefox must be in your PATH for this to work.
...
public final class WebBrowserControl {
	 ...
	 *<p>
	 *  In general, it is better for the user to set a preference for
	...
	public static String getUnixPath() {
		...
		if ("".equals(command)) {
			System.out.println("Browser Command Undefined -- \n" +
