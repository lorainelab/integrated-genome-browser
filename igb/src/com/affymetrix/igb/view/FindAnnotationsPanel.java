    ...
    jPanel1Layout.setHorizontalGroup(
      ...
      .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        .addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING)
          .addComponent(ID_all_RB)
          .addGroup(jPanel1Layout.createSequentialGroup()
            .addComponent(ID_regex_RB)
            .addPreferredGap(ComponentPlacement.RELATED)
            .addComponent(ID_regex_TF, GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE))
          .addGroup(jPanel1Layout.createSequentialGroup()
            .addComponent(ID_between_RB)
            .addPreferredGap(ComponentPlacement.RELATED)
            .addComponent(ID_between_1_TF, GroupLayout.DEFAULT_SIZE, 100, Short.MAX_VALUE)
            .addPreferredGap(ComponentPlacement.RELATED)
            .addComponent(ID_and_Label)
            .addPreferredGap(ComponentPlacement.RELATED)
            .addComponent(ID_between_2_TF, GroupLayout.DEFAULT_SIZE, 100, Short.MAX_VALUE))
          .addGroup(jPanel1Layout.createSequentialGroup()
            .addComponent(ID_starts_with_RB)
            .addPreferredGap(ComponentPlacement.RELATED)
            .addComponent(ID_starts_with_TF, GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE))
          .addGroup(jPanel1Layout.createSequentialGroup()
            .addComponent(ID_exact_RB)
            .addPreferredGap(ComponentPlacement.RELATED)
            .addComponent(ID_exact_TF, GroupLayout.DEFAULT_SIZE, 252, Short.MAX_VALUE)))
        .addContainerGap())
    );
    jPanel1Layout.setVerticalGroup(
      ...
      .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        .addGroup(jPanel1Layout.createParallelGroup(Alignment.BASELINE)
          .addComponent(ID_exact_RB)
          .addComponent(ID_exact_TF, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
        .addPreferredGap(ComponentPlacement.RELATED)
        .addGroup(jPanel1Layout.createParallelGroup(Alignment.BASELINE)
          .addComponent(ID_starts_with_RB)
          .addComponent(ID_starts_with_TF, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
        .addPreferredGap(ComponentPlacement.RELATED)
        .addGroup(jPanel1Layout.createParallelGroup(Alignment.BASELINE)
          .addComponent(ID_between_RB)
          .addComponent(ID_between_2_TF, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
          .addComponent(ID_and_Label)
          .addComponent(ID_between_1_TF, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
        .addPreferredGap(ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        .addGroup(jPanel1Layout.createParallelGroup(Alignment.BASELINE)
          .addComponent(ID_regex_RB)
          .addComponent(ID_regex_TF, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
        .addGap(52, 52, 52))
    );
    ...
    jPanel2Layout.setHorizontalGroup(
      ...
      .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        .addGroup(jPanel2Layout.createParallelGroup(Alignment.LEADING)
          .addComponent(SEQ_all_RB)
          .addGroup(jPanel2Layout.createSequentialGroup()
            .addComponent(SEQ_name_RB)
            .addPreferredGap(ComponentPlacement.RELATED)
            .addComponent(sequence_CB, 0, 246, Short.MAX_VALUE)))
        .addContainerGap())
    );
    jPanel2Layout.setVerticalGroup(
      ...
      .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        .addGroup(jPanel2Layout.createParallelGroup(Alignment.BASELINE)
          .addComponent(SEQ_name_RB)
          .addComponent(sequence_CB, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
