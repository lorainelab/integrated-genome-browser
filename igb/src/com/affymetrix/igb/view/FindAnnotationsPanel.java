      ...
      .add(jPanel1Layout.createSequentialGroup()
        ...
        .add(jPanel1Layout.createParallelGroup(GroupLayout.LEADING)
          ...
          .add(jPanel1Layout.createSequentialGroup()
            ...
            .add(ID_regex_TF, GroupLayout.DEFAULT_SIZE, 202, Short.MAX_VALUE))
          .add(jPanel1Layout.createSequentialGroup()
            .add(ID_between_RB)
            .addPreferredGap(LayoutStyle.RELATED)
            .add(ID_between_1_TF, GroupLayout.DEFAULT_SIZE, 99, Short.MAX_VALUE)
            .addPreferredGap(LayoutStyle.RELATED)
            .add(ID_and_Label)
            .addPreferredGap(LayoutStyle.RELATED)
            .add(ID_between_2_TF, GroupLayout.DEFAULT_SIZE, 113, Short.MAX_VALUE))
          .add(jPanel1Layout.createSequentialGroup()
            .add(ID_starts_with_RB)
            .addPreferredGap(LayoutStyle.RELATED)
            .add(ID_starts_with_TF, GroupLayout.DEFAULT_SIZE, 228, Short.MAX_VALUE))
          .add(jPanel1Layout.createSequentialGroup()
            .add(ID_exact_RB)
            .addPreferredGap(LayoutStyle.RELATED)
