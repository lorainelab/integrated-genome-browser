...
public class WebLinkEditorPanel extends JPanel {
  ...
  JTextField url_tf = new JTextField("");
  JTextField regex_tf = new JTextField("");
  JRadioButton all_b = new JRadioButton("All Tiers");
  JRadioButton regex_b = new JRadioButton("Match Tier");
  ButtonGroup but_group_1 = new ButtonGroup();
   ...
   */
  void setLinkPropertiesFromGUIx() throws IllegalArgumentException, PatternSyntaxException {
