...
import org.lorainelab.igb.protannot.event.ZoomInEvent;
import org.lorainelab.igb.protannot.event.ZoomOutEvent;
...
import org.lorainelab.igb.protannot.view.LineContainerProtAnnotGlyph;
import org.lorainelab.igb.protannot.view.ProtAnnotLabelledRectGlyph;
import org.lorainelab.igb.protannot.view.ProtAnnotMapTierGlyph;
import org.lorainelab.igb.protannot.view.ProtannotEfficientLabelledLineGlyph;
import org.lorainelab.igb.protannot.view.TabPanelComponent;
    ...
    private void glyphifyProteinAnnots(
        ...
        for (int i = 0; i < count1; i++) {
            ...
            for (int j = 0; j < count2; j++) {
                ...
                String label = null;
                label = (String) ((SymWithProps) annot2protein).getProperty("InterPro name");
                if (Strings.isNullOrEmpty(label)) {
                    label = (String) ((SymWithProps) annot2protein).getProperty("InterPro accession");
                }
                if (Strings.isNullOrEmpty(label)) {
                    label = (String) ((SymWithProps) annot2protein).getProperty("library");
                }
