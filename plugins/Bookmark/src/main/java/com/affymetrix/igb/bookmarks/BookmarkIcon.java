...
/**
 * An Icon to represent a bookmark. There is one visual form for a
 * UnibrowControl bookmark that opens in Unibrow and another form for one that
 * opens in an external browser. (This is currently just a test class. Not ready
 * for production use.)
 */
