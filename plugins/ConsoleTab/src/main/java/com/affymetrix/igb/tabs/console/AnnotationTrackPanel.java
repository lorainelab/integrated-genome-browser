...
public class AnnotationTrackPanel extends TrackViewPanel {
    ...
    public AnnotationTrackPanel() {
        super(BUNDLE.getString("consoleTab"), BUNDLE.getString("consoleTab"), BUNDLE.getString("annotationTooltip"), false, TAB_POSITION);
    }
    ...
    public void activate() {
        ...
        AnnotationPanelImpl ConsolePanel = new AnnotationPanelImpl(igbService);

        this.addPanel(stylePanel);
        this.addPanel(ConsolePanel);
