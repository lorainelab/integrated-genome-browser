...
public class PrimerBlastHtmlParser {
  ...
  public String parse(InputStream is, StrandedFeatureSetI results, FeatureListI fl) throws IOException, PrimerBlastHtmlParserException {
  ...
  public String parse(InputStream is, StrandedFeatureSetI results, int offset, FeatureListI fl) throws IOException, PrimerBlastHtmlParserException
  {
    ...
    FeatureListI leaves = fl != null ? fl.getAllLeaves() : null;
...
//          apollo.util.IOUtil.errorDialog("Forward primer missing reverse primer");
  ...
  private boolean isValid(SeqFeatureI fPrimer, SeqFeatureI rPrimer, FeatureListI leaves)
  {
