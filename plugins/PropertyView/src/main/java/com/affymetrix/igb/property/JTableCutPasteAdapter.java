 ...
 * ExcelAdapter code at
 *
 * http://www.javaworld.com/javaworld/javatips/jw-javatip77.html Copyright (c)
 * 2003 JavaWorld.com, an IDG company
 *
 * From documentation of ExcelAdapter: ExcelAdapter enables Copy-Paste Clipboard
 * functionality on JTables. The clipboard data format used by the adapter is
 * compatible with the clipboard format used by Excel. This provides for
...
public final class JTableCutPasteAdapter {
    ...
    /**
     * Registers the default keyboard actions for Copy (control C) and Paste
     * (control V).
     */
     ...
     * then copy action cannot be performed. Paste can be done as long as there
    ...
    public Action copyAction = new GenericAction(PropertyView.BUNDLE.getString("copy"), null, null) {
    ...
    public Action pasteAction = new GenericAction(PropertyView.BUNDLE.getString("paste"), null, null) {
        private static final long serialVersionUID = 1L;
