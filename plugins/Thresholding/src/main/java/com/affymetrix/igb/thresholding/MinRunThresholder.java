...
public final class MinRunThresholder extends JPanel
    ...
    static MinRunThresholder showFramedThresholder(GraphGlyph sgg, NeoAbstractWidget widg) {
        ...
        JFrame frm = new JFrame(BUNDLE.getString("minrunControl"));
    ...
    public MinRunThresholder(NeoAbstractWidget w) {
        ...
        tslider = new JRPSlider("MinRunThresholder_tslider", JSlider.HORIZONTAL);
        ...
        this.add(new JLabel(BUNDLE.getString("minRun") + " > "));
        this.add(minrunTF);
        this.add(tslider);
