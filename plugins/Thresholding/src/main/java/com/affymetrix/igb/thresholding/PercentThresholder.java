...
public final class PercentThresholder extends JPanel
    ...
    public PercentThresholder(NeoAbstractWidget w) {
        ...
        syncCB = new JRPCheckBox("PercentThresholder_syncCB", BUNDLE.getString("sync"));
...
//    }
    ...
    /**
     * Set visible min Y to the specified value for all graphs under control of
     * PercentThresholder (but doesn't force an updateWidget()). Argument is
     * _value_, not percentage.
     */
    ...
    /**
     * set visible max Y to the specified value for all graphs under control of
     * PercentThresholder (but doesn't force an updateWidget()). Argument is
     * _value_, not percentage.
     */
