...
public class TrackAdjusterTabGUI extends IGBTabPanel {
    ...
    private void initComponents() {
        ...
        heat_mapCB.setModel(tat.heatMapModel);
	...
	private void by_percentileRB_valActionPerformed(java.awt.event.ActionEvent evt) {                                                    
		if (tat.is_listening) {
			switchView(true);
		}
	}                                                   
	...
	private void nameSizeComboBoxtrackNameSizeComboBoxActionPerformed(java.awt.event.ActionEvent evt) {                                                                      
		if (tat.is_listening) {
	...
	private void by_valRB_valActionPerformed(java.awt.event.ActionEvent evt) {                                             
		switchView(false);
	}                                            
	...
	private void maxStackDepthTextFieldActionPerformed(java.awt.event.ActionEvent evt) {                                                       
		if (tat.is_listening) {
	...
	private void AnnotationButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                 
		if (tat.is_listening) {
	...
	private void StylePanelMouseClicked(java.awt.event.MouseEvent evt) {                                        
	...
	private void AnnotationPanelMouseClicked(java.awt.event.MouseEvent evt) {                                             
	...
	private void height_sliderStateChanged(javax.swing.event.ChangeEvent evt) {                                           
		if (!tat.is_listening) {
			return;
		}
	...
	private void fitViewButtonActionPerformed(java.awt.event.ActionEvent evt) {                                              
		int ourOptimum = 1;
	...
	private void StylePanelMouseMoved(java.awt.event.MouseEvent evt) {                                      
		Rectangle bounds = new Rectangle(43, 5, 57, 13);
		if (bounds.contains(evt.getX(), evt.getY())) {
	...
	private void AnnotationPanelMouseMoved(java.awt.event.MouseEvent evt) {                                           
		Rectangle bounds = new Rectangle(85, 5, 55, 13);
		if (bounds.contains(evt.getX(), evt.getY())) {
			this.setCursor(openHandCursor);
		} else {
	...
	private void labelFGComboBoxActionPerformed(java.awt.event.ActionEvent evt) {                                                
		if (tat.is_listening) {
	...
	private void selectAllCBActionPerformed(java.awt.event.ActionEvent evt) {                                            
        tat.selectAllCBSelected();	}                                           

	private void configureOtherButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                     
