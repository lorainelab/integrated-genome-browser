...
public interface IPluginsHandler {
	...
	/**
	 * get the number of filtered bundles, these are
	 * the bundles shown in the table
	...
	/**
	 * determines if the specified bundle can be updated to
	 * a newer version
	 * @param bundle the bundle to check
	 * @return if there is a newer version of the bundle that
	 * can be installed
	 */
	 ...
	 * @param bundle the bundle to check
	 * @return the latest version of the bundle in all
	 * the repositories
	 */
