...
public abstract class OperationsPanelGui extends javax.swing.JPanel {

    protected boolean isListening = true; // used to turn on and off listening to GUI events
    private static final long serialVersionUID = 1L;

    public OperationsPanelGui() {
        initComponents();
    }
