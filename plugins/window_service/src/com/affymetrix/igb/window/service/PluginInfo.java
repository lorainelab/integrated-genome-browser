...
public final class PluginInfo {
	...
	public PluginInfo(String class_name, String plugin_name, boolean load, int default_position) {
	...
	public String toString() {
		return "IGB PluginInfo: " +
						"name = " + plugin_name + ", class = " + class_name + ", load = " + load + ", default_position = " + default_position;
	}
