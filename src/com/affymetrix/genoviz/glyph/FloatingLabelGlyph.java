...
public class FloatingLabelGlyph extends Glyph
{
  ...
  public void draw(ViewI view) {
    ...
    Rectangle2D.Double parent_box = parent.getCoordBox();
    ...
    if (text_width <= pixelbox.width) {
        Rectangle parent_pix = view.getScratchPixBox();
        parent_pix = view.transformToPixels (parent.getCoordBox(), parent_pix);
