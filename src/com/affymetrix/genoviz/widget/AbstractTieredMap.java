 ...
 */
public abstract class AbstractTieredMap extends NeoMap
  ...
  public void packTiers(boolean full_repack, boolean stretch_map)  {
    ...
    if (notifyOnPackTiers) {
      notifyTierEventListeners(new TierEvent(this, TierEvent.REPACK, null, full_repack, stretch_map));
    }
  }
   ...
   */
  //TODO: delete?  This probably refers to some ancient special case
